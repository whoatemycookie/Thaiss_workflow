...
load("data/gm_DO112_allqc.RData")
load("data/gm_DO112.RData")

#gm_qc = gm_DO112_allqc

#gm = gm

#finding individuals with no phenotyoes

gm_DO112_allqc$pheno[102,1] = gm$pheno[111,1]
gm_DO112_allqc$pheno[102,2] = gm$pheno[111,2]
gm_DO112_allqc$pheno[102,3] = gm$pheno[111,3]
gm_DO112_allqc$pheno[102,4] = gm$pheno[111,4]

gm_DO112_allqc$covar[102,3] = gm$covar[111,3]
...
gmapn <- gm_DO112_allqc$gmap
pmapn <- gm_DO112_allqc$pmap

gmap <- gm$gmap
pmap <- gm$pmap

#prcl <- calc_genoprob(gm_DO112_allqc, gmap, error_prob=0.002, map_function="c-f", cores=0)
#prcl <- get(load("data/pr_DO112_allqc.RData"))
#save(prcl,"data/prcl.RData")
prcl <- get(load("data/prcl_allqc.RData"))
pr <- get(load("data/pr.RData"))

prcl <- prcl[ind_ids(gm_DO112_allqc),]
pr <- pr[ind_ids(gm_DO112_allqc),]
```
...
for(i in unique(ind_ids(gm_DO112_allqc))) {
