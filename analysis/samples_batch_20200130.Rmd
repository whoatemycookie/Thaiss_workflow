---
title: "Samples [Batch: MURMUGV01_20200130]"
...
filepathg = '/Users/corneb/Documents/MyJax/CS/Projects/data/Univ_of_Penn_Thaiss/Neogen/Univ_of_Penn_Thaiss_MURMUGV01_20200130/'
filepaths = '/Users/corneb/Documents/MyJax/CS/Projects/data/Univ_of_Penn_Thaiss/Neogen/Univ_of_Penn_Thaiss_MURMUGV01_20200130/'
...
summary[c(1:17)] %>%
  ...
  row_spec(100,color= "white",background = "red") %>%
  row_spec(102,color= "white",background = "red") %>%
...
summary[c(1,2,22:27)] %>%
  ...
  row_spec(95 ,color= "white",background = "green") %>%
  row_spec(96 ,color= "white",background = "green") %>%
  row_spec(97 ,color= "white",background = "green") %>%
  row_spec(98 ,color= "white",background = "green") %>%
  row_spec(99 ,color= "white",background = "green") %>%
  row_spec(100,color= "white",background = "blue") %>%
  row_spec(102,color= "white",background = "blue") %>%
  row_spec(32,color= "white",background = "blue") %>%  
