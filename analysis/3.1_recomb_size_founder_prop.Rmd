...
gm_DO112_ssqc$covar$id = rownames(gm_DO112_ssqc$covar)

unique(gm_DO112_ssqc$covar$ngen)

### Subset To Each Generation
for(g in unique(gm_DO112_ssqc$covar$ngen)){
  #g = "32"
  print(g)
  apr.3d <- apr.3d.all[gm_DO112_ssqc$covar[gm_DO112_ssqc$covar$ngen == g,"id"],,]
...
pos <- locate_xo(g, gm_DO112_ssqc$gmap, cores = 20)

pos_ind <- list()
for(i in ind_ids(gm_DO112_ssqc)){
  pos_ind[[i]] <- list()
  for (j in c(1:19, "X")) {
...
for(g in unique(gm_DO112_ssqc$covar$ngen)){
  #g = "21"
  pos_ind_gen[[g]] <- as.vector(unlist(pos_ind[gm_DO112_ssqc$covar[gm_DO112_ssqc$covar$ngen == g,"id"]]))
}
save(pos_ind, pos_ind_gen, file = "data/recom_block_size.RData")
...
p <- list()
for(c in unique(names(gm_DO112_ssqc$geno))){
  print(c)
...
+ [Chromosome 1](prop_across_generation_chr1.html)
+ [Chromosome 2](prop_across_generation_chr2.html)
+ [Chromosome 3](prop_across_generation_chr3.html)
+ [Chromosome 4](prop_across_generation_chr4.html)
+ [Chromosome 5](prop_across_generation_chr5.html)
+ [Chromosome 6](prop_across_generation_chr6.html)
+ [Chromosome 7](prop_across_generation_chr7.html)
+ [Chromosome 8](prop_across_generation_chr8.html)
+ [Chromosome 9](prop_across_generation_chr9.html)
+ [Chromosome 10](prop_across_generation_chr10.html)
+ [Chromosome 11](prop_across_generation_chr11.html)
+ [Chromosome 12](prop_across_generation_chr12.html)
+ [Chromosome 13](prop_across_generation_chr13.html)
+ [Chromosome 14](prop_across_generation_chr14.html)
+ [Chromosome 15](prop_across_generation_chr15.html)
+ [Chromosome 16](prop_across_generation_chr16.html)
+ [Chromosome 17](prop_across_generation_chr17.html)
+ [Chromosome 18](prop_across_generation_chr18.html)
+ [Chromosome 19](prop_across_generation_chr19.html)
+ [Chromosome X](prop_across_generation_chrX.html)
